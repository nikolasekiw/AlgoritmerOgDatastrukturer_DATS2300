...
class Week3Test {
    ...
    void findMax() {
        ...
        int max_1 = Week3.findMax(values, 0, 4); //starter med index 0
        //expected 1: forventer at det største tallet ligger i index 1
    ...
    void binarySearch() {
        ...
        assertEquals(4, index_7);  //skrive flrst hvor 7 ligger så tallet vi leter etter
